...
class SchollSubjectController extends Controller
{
    ...
    public function SchoolSubjectStore(Request $request){
        ...
        $notification=array(
            'message'=>'School Subject Inserterd Successfully',
            'alert-type'=>'success',
        );

        return redirect()->route('scholl.subject.view')->with($notification);
    }
